...
**Reference:** `references/firm-formatting.md`
**Prerequisite:** Phase 6 complete (Returns tab built, all model content finalized).
**Next phase:** Phase 8 (QC) → load `references/phase-8-qc.md`
...
`references/firm-formatting.md` is the single source of truth for all formatting. Load it for the complete spec.
