---
name: build-model-phase-09
description: |
  Phase 9 -- QC (Quality Control). Runs quality gates, checks BS balance, CFS reconciliation, lease integrity, and historicals integrity.
...
Formatting applied to all tabs (Phase 8 complete): [check/x]
...
See `phase-9-qc.md` for the complete phase reference.

## After Completing This Phase

1. Verify Definition of Done (see phase instructions)
2. Clear context (start new conversation)
3. Next phase: load `build-model` + `firm-formatting` + `build-model-phase-10`
