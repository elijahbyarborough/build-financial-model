<!-- CANONICAL COPY: build-model-phase-4/meth-interest-debt.md — sync edits there first -->

## Interest Expense & Debt

### Default Architecture: Aggregate Roll (per meth-debt-build)

The default debt build is the **single aggregate Total Debt roll-forward** with one net-issuance assumption, per `meth-debt-build.md` (canonical build methodology, build-model-phase-3). Most companies need nothing more.
