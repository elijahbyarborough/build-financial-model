...
description: |
  Phase 11 -- Consensus Comparison. Compares model projections against Street consensus estimates and flags variances.
...
Output tab complete: [check/x]
All cross-tab dependencies wired: [check/x]
```
...
See `phase-11-consensus.md` for the complete phase reference.
...
4. Next phase: load `build-model` + `firm-formatting` + `build-model-phase-12`
